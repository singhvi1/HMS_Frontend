...
const MaintenanceForm = ({ user }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8 m-5">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 p-2 block w-full rounded-lg border-gray-300 bg-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                disabled
              />
            </div>
          </div>
